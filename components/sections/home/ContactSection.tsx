...
function WhatsAppCard() {
  return (
    <a
      ...
      className="group relative flex cursor-pointer flex-col justify-between overflow-hidden rounded-2xl bg-primary p-6 sm:p-8 shadow-xl transition-all active:scale-[0.98]"
    >
      {/* Blob decorativo */}
      ...
      <div>
        ...
        <p className="mb-1 text-sm font-extrabold uppercase tracking-widest text-primary-foreground/70">
          WhatsApp
        </p>
        <h3 className="mb-2 text-3xl font-extrabold tracking-tight text-primary-foreground">
          +51 {WHATSAPP_NUMBER}
        </h3>
        <p className="text-primary-foreground/85 font-medium leading-relaxed md:text-lg md:font-semibold">
...
function EmailCard() {
  return (
    <a
      href={`mailto:${EMAIL}`}
      className="group flex flex-col justify-between rounded-2xl bg-card p-6 sm:p-8 shadow-sm ring-1 ring-border transition-all hover:shadow-md active:scale-[0.98]"
    >
      <div>
        ...
        <p className="text-sm font-medium leading-relaxed text-muted-foreground md:text-base md:font-semibold">
...
function ScheduleCard() {
  return (
    <div className="flex flex-col justify-between rounded-2xl bg-card p-6 sm:p-8 shadow-sm ring-1 ring-border">
      <div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <header className="mb-12">
        <h2 className="mb-4 text-4xl font-black tracking-tight text-primary md:text-5xl">
          Contáctanos
        </h2>
        <p className="max-w-2xl text-lg font-medium leading-relaxed text-muted-foreground md:font-semibold">
