import type { ServiceOut, ServiceCategoryOut, ServiceAddon } from "@/types/services";
...
export const servicesService = {
  ...
  listProductsByCategory(
    ...
    return apiClient.get<ServiceOut[]>(`${ENDPOINTS.STORE.CATEGORY_PRODUCTS(slug)}${query}`);
  },
   ...
   */
  getProduct(id: string, params?: { pet_id?: string }): Promise<ServiceOut & { available_addons: ServiceAddon[] }> {
